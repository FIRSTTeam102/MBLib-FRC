...
/**
 * A version of {@link PIDSubsystemDrive} that supports "universal" driving
 */
public abstract class AdvancedPIDSubsystemDrive extends PIDSubsystemDrive {
	...
	/**
	 * Creates a {@link edu.wpi.first.wpilibj.drive.DifferentialDrive Differential drive}-based {@link AdvancedPIDSubsystemDrive}, for more than one motor on each side
	 ...
	 */
	public AdvancedPIDSubsystemDrive(double p, double i, double d, SpeedController[] left, SpeedController[] right) { this(p, i, d,
	...
	/**
	 * Creates a {@link edu.wpi.first.wpilibj.drive.KilloughDrive Killough drive}-based {@link AdvancedPIDSubsystemDrive}
	 * @param p The proportional coefficient
	 * @param i The integral coefficient
	 ...
	 */
	public AdvancedPIDSubsystemDrive(double p, double i, double d, SpeedController left, SpeedController right, SpeedController back) { this(p, i, d, new SpeedController[] { left, right, back }); }
	
	/**
	 * Creates a {@link edu.wpi.first.wpilibj.drive.MecanumDrive Mecanum drive}-based {@link AdvancedPIDSubsystemDrive}
	 * @param p The proportional coefficient
	 * @param i The integral coefficient
	 ...
	 */
	public AdvancedPIDSubsystemDrive(double p, double i, double d, SpeedController fL, SpeedController rL, SpeedController fR, SpeedController rR) { this(p, i, d, new SpeedController[] { fL, rL, fR, rR }); }
	
	/**
	 * Creates a {@link edu.wpi.first.wpilibj.drive.DifferentialDrive Differential drive}-based {@link AdvancedPIDSubsystemDrive}
	 * @param p The proportional coefficient
	 * @param i The integral coefficient
	 ...
	 */
	public AdvancedPIDSubsystemDrive(double p, double i, double d, SpeedController left, SpeedController right) { this(p, i, d, new SpeedController[] { left, right }); }
	
	/**
	 * Creates an {@link AdvancedPIDSubsystemDrive} with the name "Drive Train"
	 * @param p The proportional coefficient
	 * @param i The integral coefficient
	 ...
	 */
	public AdvancedPIDSubsystemDrive(double p, double i, double d, SpeedController[] controllers) { this(p, i, d, IDriveSubsystem.createDrive(controllers)); }
	
	/**
	 * Instantiates an {@link AdvancedPIDSubsystemDrive} that will use the given p, i and d values.
	 * @param name The name
	 * @param p The proportional coefficient
	 * @param i The integral coefficient
	 ...
	 */
	public AdvancedPIDSubsystemDrive(String name, double p, double i, double d, RobotDriveBase drive) { super(name, p, i, d, drive);}
	 ...
	 * @param drive The {@link RobotDriveBase drive system} to be used
	 */
	public AdvancedPIDSubsystemDrive(String name, double p, double i, double d, double f, RobotDriveBase drive) { super(name, p, i, d, f, drive);}
	
	/**
	 * Instantiates an {@link AdvancedPIDSubsystemDrive} that will use the given p, i and d values. It will also
	 ...
	 * @param drive The {@link RobotDriveBase drive system} to be used
	 */
	public AdvancedPIDSubsystemDrive(String name, double p, double i, double d, double f, double period, RobotDriveBase drive) { super(name, p, i, d, f, period, drive);}
	
	/**
	 * Instantiates an {@link AdvancedPIDSubsystemDrive} that will use the given p, i and d values. It will use "Drive
	 * Train" as its name.
	 * @param p The proportional coefficient
	 * @param i The integral coefficient
	 * @param d The derivative coefficient
	 * @param drive The {@link RobotDriveBase drive system} to be used
	 */
	public AdvancedPIDSubsystemDrive(double p, double i, double d, RobotDriveBase drive) { super(SUGGESTED_NAME, p, i, d, drive);}
	 ...
	 * @param drive The {@link RobotDriveBase drive system} to be used
	 */
	public AdvancedPIDSubsystemDrive(double p, double i, double d, double period, double f, RobotDriveBase drive) { super(SUGGESTED_NAME, p, i, d, period, f, drive);}
	 ...
	 * @param drive The {@link RobotDriveBase drive system} to be used
	 */
	public AdvancedPIDSubsystemDrive(double p, double i, double d, double period, RobotDriveBase drive) { super(SUGGESTED_NAME, p, i, d, period, drive);}
